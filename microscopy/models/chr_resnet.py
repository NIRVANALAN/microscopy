...
__all__ = ['resnet101_chr', 'resnet50_chr']
...
def resnet101_chr(**kwargs):
    return ResNetCHR(Bottleneck, [3, 4, 23, 3], **kwargs)


def resnet50_chr(**kwargs):
    return ResNetCHR(Bottleneck, [3, 4, 6, 3], **kwargs)
